...
inline const std::string& RpcResponse::error_message() const {
  // @@protoc_insertion_point(field_get:rpc.RpcResponse.error_message)
...
void RpcResponse::set_error_message(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.error_message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc.RpcResponse.error_message)
}
inline std::string* RpcResponse::mutable_error_message() {
  std::string* _s = _internal_mutable_error_message();
  // @@protoc_insertion_point(field_mutable:rpc.RpcResponse.error_message)
  return _s;
}
...
inline std::string* RpcResponse::release_error_message() {
  // @@protoc_insertion_point(field_release:rpc.RpcResponse.error_message)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:rpc.RpcResponse.error_message)
}
