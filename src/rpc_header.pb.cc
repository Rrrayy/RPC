...
// source: src/rpc_header.proto

#include "src/rpc_header.pb.h"
...
static ::_pb::Metadata file_level_metadata_src_2frpc_5fheader_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_src_2frpc_5fheader_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_src_2frpc_5fheader_2eproto = nullptr;

const uint32_t TableStruct_src_2frpc_5fheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_src_2frpc_5fheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024src/rpc_header.proto\022\003rpc\"I\n\tRpcHeader"
  "\022\024\n\014service_name\030\001 \001(\t\022\023\n\013method_name\030\002 "
  "\001(\t\022\021\n\targs_size\030\003 \001(\rb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_src_2frpc_5fheader_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_src_2frpc_5fheader_2eproto = {
    false, false, 110, descriptor_table_protodef_src_2frpc_5fheader_2eproto,
    "src/rpc_header.proto",
    &descriptor_table_src_2frpc_5fheader_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_src_2frpc_5fheader_2eproto::offsets,
    file_level_metadata_src_2frpc_5fheader_2eproto, file_level_enum_descriptors_src_2frpc_5fheader_2eproto,
    file_level_service_descriptors_src_2frpc_5fheader_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_src_2frpc_5fheader_2eproto_getter() {
  return &descriptor_table_src_2frpc_5fheader_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_src_2frpc_5fheader_2eproto(&descriptor_table_src_2frpc_5fheader_2eproto);
namespace rpc {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "rpc.RpcHeader.service_name"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "rpc.RpcHeader.method_name"));
        } else
          goto handle_unusual;
        continue;
      // uint32 args_size = 3;
...
::PROTOBUF_NAMESPACE_ID::Metadata RpcHeader::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_src_2frpc_5fheader_2eproto_getter, &descriptor_table_src_2frpc_5fheader_2eproto_once,
      file_level_metadata_src_2frpc_5fheader_2eproto[0]);
}
